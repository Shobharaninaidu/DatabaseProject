...
public class DbConnection {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/ecommerce", "root", "Vaishnavi@26");
		...
		while (result.next()) {
			...
			System.out.println("Price of Product " + result.getDouble("price"));
		}
